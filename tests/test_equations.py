...
class TestEquations(unittest.TestCase):
    ...
    def test_convert_cap_factor_to_rate(self):
        ...
        self.assertEqual(equations.convert_cap_factor_to_rate(cf, t, "LIN"),(cf-1)/t)
        self.assertEqual(equations.convert_cap_factor_to_rate(cf, t, "YLD"),(cf**(1/t)) - 1)
        with self.assertRaises(Exception):
    ...
    def test_convert_disc_factor_to_rate(self):
        ...
        d2 = ddh('t+1y')
        t = utils.delta_t(d1, d2, dc, cal)
        self.assertEqual(equations.convert_disc_factor_to_rate(df, t, "EXP"),(ln(1/df)/t))
